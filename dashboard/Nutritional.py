...
st.markdown("""
    ...
    .header {
        font-size: 40px;
        font-weight: bold;
        color: #4CAF50; /* Replace with your preferred color */
        text-align: center;
        margin-top: 50px;
    }
    .subheader {
        font-size: 30px;
        font-weight: bold;
        color: #2196F3; /* Replace with your preferred color */
    }
    .section {
        margin-bottom: 40px;
    }
    .meal-container {
        background-color: #f4f4f4; /* Replace with your preferred color */
        border-radius: 10px;
        padding: 20px;
        margin: 10px 0;
    }
    .meal-title {
        font-size: 20px;
        font-weight: bold;
        color: #333; /* Replace with your preferred color */
    }
    .meal-info {
        font-size: 16px;
        color: #555; /* Replace with your preferred color */
    }
    .comparison {
        background-color: #e3f2fd; /* Replace with your preferred color */
        padding: 20px;
        border-radius: 8px;
        margin-top: 20px;
